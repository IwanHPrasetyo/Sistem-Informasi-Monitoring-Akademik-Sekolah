                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_pembayaran.php"><input type="button" class="btn btn-round btn-info" value="Tambah Tagihan"/></a>
                      </div>
                        <tr>
                          <th>Kode Tagihan</th>
                          <th>Nama Siswa</th>
					...
					$sql = "SELECT * FROM tb_pembayaran as p join tb_siswa as s on p.nipd = s.nipd join tb_tagihan as t on p.id_tagihan = t.id_tagihan where p.npsn='$npsn'";
					$data = $conn->query($sql);
					while($row = $data->fetch_array()){

					 ?>
					 <tr>
					 	<td><?php echo $row['id_tagihan'];?>
                         </td>
                         <td><?php echo $row['nama_siswa'];?>
                         </td>
                         <td><?php echo $row['nama_tagihan'];?>
                         </td>
                         <td><?php echo "Rp.".number_format($row['nominal_tagihan'],2,',','.');?>
                         </td>
                         <td><?php echo "Rp.".number_format($row['nominal_pembayaran'],2,',','.');?>
					 	</td>
					 	<td><?php echo $row['tanggal_pembayaran'];?>
					 	</td>

              <?php $keterangan = $row['keterangan_bayar'];  

                    if($keterangan == 'Lunas'){
                       $keterangan = "<span class='label label-info' >".$row['keterangan_bayar']."</span>";
                    }
                    else{
                      $keterangan = "<font color='red' >Rp.".number_format($row['keterangan_bayar'],2,',','.')."</font>";
                    }
              ?>
					 	...
					 	<td>
             <center><a  href="form_edit_pembayaran.php?id=<?php echo $row['id_pembayaran']; ?>" ><input type="submit" class="btn btn-round btn-success" value="Edit"></a>
            </td>
            <td>
            <center><a  href="proses/hapus_administrasi.php?id=<?php echo $row['id_pembayaran']; ?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a></center>
					 	</center
            </td>
					 </tr>
					 <?php
