                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_guru.php"><input type="button" class="btn btn-round btn-info" value="Tambah Data Guru"/></a>
                      </div>
                        <tr>
                          <th>NIP</th>
                          <th>NUPTK</th>
					...
					$sql = "SELECT * FROM tb_karyawan  where status_kepegawaian = 'Guru' and npsn='$npsn' ";
					$data = $conn->query($sql);
					while($row = $data->fetch_array()){
					 ...
					 <tr>
					 	...
					 	<td>
             <center><a  href="profile_karyawan.php?id=<?php echo $row['kode_guru']; ?>" ><input type="submit" class="btn btn-round btn-info" value="Lihat"></a></center>
					 	</td>
					 </tr>
					 <?php
					}
