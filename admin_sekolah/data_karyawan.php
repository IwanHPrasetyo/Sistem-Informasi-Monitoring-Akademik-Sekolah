                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_guru.php"><input type="button" class="btn btn-round btn-success" value="Tambah Data Karyawan"/></a>
                      </div>
                        <tr>
                          <th>Kode Guru</th>
                          <th>NIP</th>
					...
					$sql = "SELECT * FROM tb_karyawan where npsn ='$npsn' ";
					$data = $conn->query($sql);
					while($row = $data->fetch_array()){

					 ?>
					 <tr>
					 	             <td><?php echo $row['kode_guru'];?>
                         </td>
                         <td><?php echo $row['nip'];?>
                         </td>
                         <td><?php echo $row['nama_karyawan'];?>
                         </td>
                         <td><?php echo $row['status_kepegawaian'];?>
					 	             </td>
					 	...
					 	<td>
             <center><a  href="profile_karyawan.php?id=<?php echo $row['kode_guru']; ?>" ><input type="submit" class="btn btn-round btn-primary" value="Lihat"></a></center>
					 	</td>
             <td>
             <center><a  href="proses/hapus_karyawan.php?id=<?php echo $row['kode_guru']; ?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a></center>
					 	</td>
					 </tr>
					 <?php
					}
