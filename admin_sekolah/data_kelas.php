...
<body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_jurusan.php"><input type="button" class="btn btn-round btn-info" value="Tambah Data Jurusan"/></a>
                      </div>
                        <tr>
                          <th>Kode Jurusan</th>
                          <th>Nama Jurusan</th>
          ...
          include_once("proses/koneksi.php");
					...
					$sql = "SELECT * FROM tb_jurusan where npsn='$npsn'";
					$data = $conn->query($sql);
					while($row = $data->fetch_array()){

					 ?>
					 <tr>
					 	<td><?php echo $row['id_jurusan'];?>
                         </td>
                         ...
                         <td>
             <center>
             <a   href="form_edit_jurusan.php?id=<?php echo $row['id_jurusan'];?>" ><input type="submit" class="btn btn-round btn-success" value="Edit"></a>
             <a   href="proses/hapus_jurusan.php?id=<?php echo $row['id_jurusan'];?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a>
