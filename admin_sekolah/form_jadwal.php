                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" method="post" action="proses/tambah_jadwal.php">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <input type="time" value = "00:00" class="form-text" name="jam_mulai" required>
                            <span class="bar"></span>
                            <label><span class="fa-graduation-cap fa"></span>Jam Mulai</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <input type="time" value = "00:00" class="form-text" name="jam_akhir" required>
                            <span class="bar"></span>
