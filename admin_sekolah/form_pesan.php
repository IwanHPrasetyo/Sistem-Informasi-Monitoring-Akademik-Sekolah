...
$(document).ready(function(){
    $('.search-box input[type="text"]').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("proses/cari_tujuan.php", {term: inputVal}).done(function(data){
                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      ...
                      <form class="cmxform" method="POST" action="proses/tambah_pesan.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                          ...
                          <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            ...
                            <input type="text" autocomplete="off" class="form-text" name="nama_tujuan" required>
                            <span class="bar"></span>
                            <div class="result"></div>
                            <label><span class="fa-graduation-cap fa"></span>Nama Penerima</label>
                            </div>
                            </div>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              ...
                              <span class="bar"></span>
                              <label><span class="fa-map-o fa"></span>Pesan</label>
                            </div> 
