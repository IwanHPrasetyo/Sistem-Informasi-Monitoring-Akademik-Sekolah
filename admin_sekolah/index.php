<?php 
  ...
  $_SESSION['nama_sekolah'] = $profil_row['nama_sekolah'];
  $_SESSION['foto']         = $profil_row['foto'];
?>
             ...
             <div class="col-md-12 col-sm-12 profile-v1-wrapper">
                <div class="col-md-9  profile-v1-cover-wrap" style="padding-right:0px;">
                    <div class="profile-v1-pp">
                      <img src="asset/foto/sekolah/<?php echo $profil_row['foto']; ?>"/>
                      <strong><h2><?php echo $profil_row['nama_sekolah']; ?></h2></strong>
             ...
             <div class="col-md-12 col-sm-12 profile-v1-body">
                <div class="col-md-7">
                  ...
                  <?php 
                      ...
                      $sql2 = mysqli_query($conn,"SELECT * FROM tb_info_sekolah where npsn ='$npsn' or npsn = '1' group by id desc ");
                      $folder = "";
                      while($row = mysqli_fetch_array($sql2)){
                        ...
                        if ($row['npsn'] == 1){
                          ...
                          $foto = $profil_row['foto'];
                          $nama = $profil_row['nama_sekolah'];
                        }
                        ...
                        <div class="panel-body">
                          <div class="col-md-12 padding-0 box-v7-header">
                              <div class="col-md-12 padding-0">
                                  ...
                                  <img src="../admin_sekolah/asset/foto/sekolah/<?php echo $foto; ?>" class="box-v7-avatar pull-left" />
                                  <h4><?php echo $nama; ?></h4>
