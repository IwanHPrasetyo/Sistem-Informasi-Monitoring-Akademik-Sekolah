             ...
             <div class="col-md-12 col-sm-12 profile-v1-wrapper">
                <div class="col-md-9  profile-v1-cover-wrap" style="padding-right:0px;">
                    <div class="profile-v1-pp">
                      <img style="height:15%; width:15%;"  src="asset/foto/guru/<?php echo $data['foto']; ?>"/>
 ...
 <div class="col-md-12">
                ...
                <div class="tab-content tab-content-v5">
                  <div class="tab-pane fade in active" id="tabs-demo6-area1">
                    ...
                    <h3 class="head text-center">Profil Karyawan<sup>™</sup> <span style="color:#f48250;">♥</span></h3>
               ...
               echo"  <tr>
                        <td><span class='fa fa-asterisk' style ='margin-right:10%;'></span>Kode Guru</td>
                        <td>".$data['kode_guru']."</td> 	
                      </tr>
                     
                      <tr>
                        <td><span class='fa fa-odnoklassniki-square' style ='margin-right:10%;'></span>NIP</td>
                        <td>".$data['nip']."</td> 	
                      </tr>

                      <tr>
                        <td><span class='fa fa-odnoklassniki' style ='margin-right:10%;'></span>Nama Karyawan</td>
                        <td>".$data['nama_karyawan']."</td> 	
                      </tr>

                      <tr>
                        <td><span class='fa fa-bed' style ='margin-right:10%;'></span>Jenis Kelamin</td>
                        <td>".$data['jk']."</td> 	
                      </tr>

                      <tr>
                        <td><span class='fa fa-calendar-check-o' style ='margin-right:10%;'></span>Jabatan</td>
                        <td>".$data['status_kepegawaian']."</td> 	
                      </tr>

                      <tr>
                        <td><span class='fa fa-tty' style ='margin-right:10%;'></span>Bidang/Mata Pelajaran</td>
                        <td>".$data['bidang']."</td> 	
                      </tr>
                        
                      <tr>
                        <td><span class='fa-home fa' style ='margin-right:10%;'></span>Telefon</td>
                        <td>".$data['telefon']."</td> 	
                      </tr>

                      <tr>
                        <td><span class='fa fa-flag' style ='margin-right:10%;'></span>Pendidikan Akhir</td>
                        <td>".$data['alamat']."</td> 	
                      </tr>
                  ...
                  <div class="col-md-12">
                              ...
                              <center><a href="form_edit_karyawan.php?id=<?php echo $data['kode_guru']; ?>">
                              <input class="btn btn-round btn-primary" type="submit" value="Edit Data Karyawan"></a>
                              </center>
                        </div>
