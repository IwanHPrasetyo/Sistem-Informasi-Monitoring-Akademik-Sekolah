...
$sql_siswa   = mysqli_query($conn,"SELECT * from tb_siswa where nipd ='$kode' and password_siswa ='$password'");
...
//$level = $data_karyawan['status_kepegawaian'];
    ...
    elseif($data_karyawan['status_kepegawaian'] == "Tata Usaha"){
        ...
        ";
          ...
          elseif($data_karyawan['status_kepegawaian'] == "Wali Kelas"){
