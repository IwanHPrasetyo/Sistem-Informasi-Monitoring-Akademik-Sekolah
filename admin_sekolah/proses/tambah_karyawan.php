  ...
  session_start();
   ...
   if(isset($_FILES['image'])){
      ...
      if(empty($errors)==true){
         ...
         $sql =mysqli_query($conn,"insert into tb_karyawan values ('$kode_guru','$nip','$npsn', '$nama_karyawan', '$kodeJK','$status_kepegawaian','$jabatan', '$telefon' , '$alamat', '$file_name','$password');")
													  or die(mysqli_error());
