              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
					...
					$sql = "SELECT * FROM tb_absensi as a join tb_pelajaran as p on a.kode_mapel = p.kode_mapel join tb_sekolah as s on a.npsn = s.npsn join tb_siswa as si on a.nipd = si.nipd where keterangan != ''";
					$data = $conn->query($sql);
