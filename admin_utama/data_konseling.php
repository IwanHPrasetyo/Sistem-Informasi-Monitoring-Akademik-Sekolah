              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
					...
					$sql = "SELECT * FROM (SELECT a.*, ka.nama_karyawan FROM tb_karyawan as ka JOIN (SELECT k.*, s.nama_siswa, s.nisn FROM tb_konseling as k join tb_siswa as s on k.nipd = s.nipd) as a ON ka.kode_guru = a.kode_guru) as al join tb_pelanggaran as pl on al.kode_pelanggaran = pl.kode_pelanggaran";
					$data = $conn->query($sql);
