                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_mata_pelajaran.php"><input type="button" class="btn btn-round btn-info" value="Tambah Data Pelajaran"/></a>
                      </div>
                        <tr>
					...
					while($row = $data->fetch_array()){
					 ...
					 ?>
					 <tr>
					 	<td><?php echo $row['kode_mapel'];?>
                         </td>
                         <td><?php echo $row['nama_pelajaran'];?>
                         </td>
                         <td><?php echo $row['semester'];?>
                         </td>
                         <td><?php echo $row['seri'];?>
                          </td>
                          <td><?php echo $row['beban_balajar'];?>
					 	             </td>
					 	<td>
             <center><a   href="proses/hapus_pelajaran.php?id=<?php echo $row['kode_mapel'];?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a></center>
					 	</td>
					 </tr>
					 <?php
					}
