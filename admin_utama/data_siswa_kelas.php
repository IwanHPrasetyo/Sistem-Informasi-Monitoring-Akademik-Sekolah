...
$sql_jurusan = mysqli_query($conn,"SELECT * FROM tb_jurusan where npsn='$npsn'") or die (mysqli_error());
          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <div style="padding:1%;">
                          <a href="form_siswa.php"><input type="button" class="btn btn-round btn-success" value="Tambah Data Siswa"/></a>
                      </div>

                      <div style="padding:1%;">
                      <div class="col-md-5">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                               <select class="form-text" name="kelas" id="kelas" required>
                                    <option>X</option>
                                    <option>XI</option>
                                    <option>XII</option>
                              </select>
                      ...
                      <div class="col-md-5">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                               <select class="form-text" name="jurusan" id="jurusan" required>
                               <?php 
                      ...
                      <div class="col-md-2">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                               ...
                               include_once('proses/ajak_kelas');
					...
					$sql = "SELECT * FROM tb_siswa as s join tb_kelas as k  on s.id_kelas = k.id_kelas join tb_jurusan as j on s.id_jurusan = j.id_jurusan where nama_kelas ='$kelas' and nama_jurusan = '$jurusan'";
					$data = $conn->query($sql);
             ...
             <center><a  href="profile.php?id=<?php echo $row['nipd']; ?>"><input type="submit" class="btn btn-round btn-info" value="Lihat"></a></center>
					 	...
					 	<td>
             <center><a  href="proses/hapus_siswa.php?id=<?php echo $row['nipd']; ?>"><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a></center>
					 	</td>
					 </tr>
					 <?php
					}
