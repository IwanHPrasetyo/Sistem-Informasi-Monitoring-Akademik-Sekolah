                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_tagihan.php"><input type="button" class="btn btn-round btn-info" value="Tambah Tagihan"/></a>
                      </div>
                        <tr>
                          <th>Kode Tagihan</th>
                          <th>Nama Tagihan</th>
					...
					while($row = $data->fetch_array()){
					 ...
					 <tr>
                         ...
                         <td><?php echo $row['tanggal_terbit'];?>
					 	             </td>
					 	             <td><?php echo $row['tanggal_akhir'];?>
					 	             </td>
					 	             <td>
                         <center><a  href="form_edit_tagihan.php?id=<?php echo $row['id_tagihan']; ?>" ><input type="submit" class="btn btn-round btn-success" value="Edit"></a>
                                 <a  href="proses/hapus_tagihan.php?id=<?php echo $row['id_tagihan']; ?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a>
                         </center>
					 	             </td>
					 </tr>
					 <?php
