            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Form Mata Pelajaran</h3>
                        <p class="animated fadeInDown">
                          Form <span class="fa-angle-right fa"></span> Form Mata Pelajaran
                        </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      ...
                      <form class="cmxform" method="POST" action="proses/tambah_pelajaran.php" enctype="multipart/form-data">

                          <div class="col-md-6">
                         
                          <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="kode_mapel" required>
                              <span class="bar"></span>
                              <label><span class="fa-graduation-cap fa"></span>Kode Mata Pelajaran</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="nama_pelajaran" required>
                              <span class="bar"></span>
                              <label><span class="fa-graduation-cap fa"></span>Nama Pelajaran</label>
                            </div>
						  

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <select class="form-text" name="semester" required>
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="seri" required>
                              <span class="bar"></span>
                              <label><span class="fa-university fa"></span>Seri</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name=beban_belajar required>
                              <span class="bar"></span>
                              <label><span class="fa-university fa"></span>Beban Belajar</label>
                            </div>
