<?php 
  ...
  session_start();
          ...
          //if(mysqli_fetch_row($sql_siswa) > 0){
            ...
            $peneriman = $nama_tujuan;

            $sql_tambah = mysqli_query($conn,"insert into tb_pesan values('$id_pesan','$pengirim','$peneriman','$pesan','$tanggal','1'); ");
            ...
            if($sql_tambah){
              ...
              <script>
                ...
                window.location = '../data_pesan_masuk.php';
              </script>
              ";
