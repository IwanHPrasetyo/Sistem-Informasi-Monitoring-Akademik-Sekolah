                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_konseling.php"><input type="button" class="btn btn-round btn-info" value="Tambah konseling"/></a>
                      </div>
                        <tr>
                          <th>Id Konseling</th>
                          <th>Nama Siswa</th>
					...
					$sql = "SELECT * FROM (SELECT a.*, ka.nama_karyawan FROM tb_karyawan as ka JOIN (SELECT k.*, s.nama_siswa, s.nisn FROM tb_konseling as k join tb_siswa as s on k.nipd = s.nipd) as a ON ka.kode_guru = a.kode_guru) as al join tb_pelanggaran as pl on al.kode_pelanggaran = pl.kode_pelanggaran where al.npsn ='$npsn'";
					$data = $conn->query($sql);
					while($row = $data->fetch_array()){

					 ?>
					 <tr>
					 	             <td><?php echo $row['id_konseling'];?>
                         </td>
                         <td><?php echo $row['nama_siswa'];?>
                         </td>
                         <td><?php echo $row['nama_karyawan'];?>
                         </td>
                         <td><?php echo $row['nama_pelanggaran'];?>
                         </td>
					 	...
					 	<td>
             <center><a  href="proses/hapus_konseling.php?id=<?php echo $row['id_konseling']; ?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a></center>
					 	</td>
					 </tr>
					 <?php
					}
