                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_pelanggaran.php"><input type="button" class="btn btn-round btn-info" value="Tambah Pelanggaran"/></a>
                      </div>
                        <tr>
					...
					$sql = "SELECT * FROM tb_pelanggaran where npsn ='$npsn'";
					$data = $conn->query($sql);
					while($row = $data->fetch_array()){

					 ?>
					 <tr>
					 	             <td><?php echo $row['kode_pelanggaran'];?>
                         </td>
                         <td><?php echo $row['nama_pelanggaran'];?>
                         </td>
                         <td><?php echo $row['jenis_pelanggaran'];?>
                         </td>
                         <td><?php echo $row['bobot'];?>
                         </td>
                          </td>
					 	<td>
             <center><a  href="proses/hapus_pelanggaran.php?id=<?php echo $row['kode_pelanggaran']; ?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a></center>
					 	</td>
					 </tr>
					 <?php
					}
