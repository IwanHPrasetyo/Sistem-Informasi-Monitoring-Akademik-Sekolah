                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_sekolah.php"><input type="button" class="btn btn-round btn-success" value="Tambah Data Sekolah"/></a>
                      </div>
                        <tr>
                          <th>NPSN</th>
                          <th>NSS</th>
					...
					while($row = $data->fetch_array()){
					 ...
					 ?>
					 <tr>
					 	             <td><?php echo $row['npsn'];?>
                         </td>
                         <td><?php echo $row['nss'];?>
                         </td>
                         <td><?php echo $row['nama_sekolah'];?>
					 	             </td>
                         <td><?php echo $row['kota'];?>
					 	             </td>
                          <td><?php echo $row['provinsi'];?>
					 	             </td>
                          <td><?php echo $row['telefon'];?>
					 	             </td>
                          <td><?php echo $row['email'];?>
					 	             </td>
                          <td><?php echo $row['kode_pos'];?>
					 	             </td>
                          <td><?php echo $row['password'];?>
					 	             </td>
					 	<td>
             <center><a  href="profile_sekolah.php?id=<?php echo $row['npsn']; ?>" ><input type="submit" class="btn btn-round btn-primary" value="Lihat"></a></center>
					 	</td>
             <td>
             <center><a  href="proses/hapus_sekolah.php?id=<?php echo $row['npsn']; ?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a></center>
					 	</td>
					 </tr>
					 <?php
					}
