                        ...
                        <form class="cmxform" id="signupForm" method="get" action="">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              ...
                              <span class="bar"></span>
                              <label><span class="fa-graduation-cap fa"></span>NISN</label>
                            </div>
						  

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">

                              <input type="text" class="form-text"  name="nis" required>
                              <span class="bar"></span>
                              <label><span class="fa-institution fa"></span>NIS</label>
                            </div>
                          ...
                          <div class="col-md-12">
                              ...
                              <center><input class="submit btn btn-primary" type="submit" value="Simpan">
                              <input class="submit btn btn-danger" type="submit" value="Hapus"></center>
                        </div>
                      </form>
