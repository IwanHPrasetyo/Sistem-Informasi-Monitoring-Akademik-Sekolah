      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <!-- start: Content -->
            <div id="content">
                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" method="post" action="proses/tambah_nilai.php">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                               <select class="form-text" name="keterangan" required>
                                    ...
                                    <option>Jenis Penilaian</option>
                                    
                                    <option>Tugas Harian</option>
                                    <option>Ujian Harian</option>
                                    <option>Ujian Tengah Semseter</option>
                                    <option>Ujian Akhir Semseter</option>
                                    

                              </select>
                            </div>

                              <center><input class="submit btn btn-primary" type="submit" value="Buat Penilaian"></center>
                        </div>
                      </form>
                ...
                <div class="panel">
                    <div class="panel-heading"><h3>Data Nilai Siswa</h3></div>
                    <div class="panel-body">
					...
					$sql = "SELECT * FROM tb_nilai_akademik as a join tb_siswa as s on a.nipd = s.nipd join tb_pelajaran as p on a.kode_mapel = p.kode_mapel join tb_kelas as k on a.id_kelas= k.id_kelas join tb_jurusan as j on a.id_jurusan = j.id_jurusan where nilai = '' and a.npsn='$npsn'";
					$data = $conn->query($sql);
					while($row = $data->fetch_array()){

					 ?>
					 <tr>
           <form class="cmxform" method="post" action="proses/edit_nilai.php?id=<?php echo $row['id_nilai'];?>">
           <td><?php echo $row['id_nilai'];?>
                         </td>
