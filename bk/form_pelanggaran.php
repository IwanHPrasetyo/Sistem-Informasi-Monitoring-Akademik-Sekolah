                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="post" action="proses/tambah_pelanggaran.php">
                          <div class="col-md-12">
                         
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="kode_pelanggaran" required>
                              <span class="bar"></span>
                              <label><span class="fa-graduation-cap fa"></span>Kode Pelanggaran</label>
                            </div>
						  

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">

                              <input type="text" class="form-text"  name="nama_pelanggaran" required>
                              <span class="bar"></span>
                              <label><span class="fa-institution fa"></span>Nama Pelanggaran</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="bobot" required>
                              <span class="bar"></span>
                              <label><span class="fa-user fa"></span>Bobot</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <select class="form-text" name="jenis_pelanggaran" required>
