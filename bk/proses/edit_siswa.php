	...
	$npsn =$_SESSION['npsn'];
					...
					if($foto == ""){
					   ...
					   $sql =mysqli_query($conn,"update tb_siswa set nama_siswa = '$nama_siswa', nisn = '$nisn', jk = '$kodeJK'
																	...
																	, id_kelas = '$kodeKLS' , id_jurusan = '$kodeJRS', asal_sekolah = '$asal_sekolah', status_sekolah = '$status_siswa',foto = '$file_name', password_siswa='$password_siswa', password_wali='$password_wali' WHERE nipd = '$nipd'")or die(mysql_error());
