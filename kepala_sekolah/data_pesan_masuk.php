...
<body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Data Pesan</h3>
                        <p class="animated fadeInDown">
                          Table <span class="fa-angle-right fa"></span> Data Pesan
                        </p>
                    </div>
                  </div>
              </div>
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Data Pesan</h3></div>
                    <div class="panel-body">
                      <div class="responsive-table">
                      <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                      <thead>
                      <div style="padding:1%;">
                            <a href="form_pesan.php"><input type="button" class="btn btn-round btn-info" value="Tulis Pesan"/></a>
                          </div>
                        <tr>
                          <th>Nama Pengirim</th>
                          <th>Pesan</th>
          ...
          $sql_data_sekolah = mysqli_query($conn,"SELECT * FROM tb_sekolah where npsn ='$npsn'");
          $data_sekolah     = mysqli_fetch_array($sql_data_sekolah);
          $nama_sekolah     = $_SESSION['nama_login'];
          $sql              = "SELECT * FROM (SELECT * from tb_pesan  where penerima = '$nama_sekolah' and pengirim != '$nama_sekolah' order by id_pesan desc) as a group by pengirim order by id_pesan desc";
					...
					while($row = $data->fetch_array()){
					 ...
					 ?>
					 <tr>
                         <td><?php echo $row['pengirim'];?>
                         </td>
                         <td><?php echo substr($row['pesan'], 0,10).' ...';?>
                          </td>
                          <td><?php echo $row['tanggal'];?>
					 	             </td>
					 	<td>
             <center><a   href="baca_pesan.php?id=<?php echo $row['pengirim'];?>" ><input type="submit" class="btn btn-round btn-primary" value="Lihat"></a></center>
					 	</td>
					 </tr>
					 <?php
					}
