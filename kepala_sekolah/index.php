<?php 
  ...
  $sql_profil_sekolah = mysqli_query($conn,"SELECT * FROM tb_sekolah where npsn='$npsn'");
  $profil_row = mysqli_fetch_array($sql_profil_sekolah);
  $sql_jumlah_guru = mysqli_query($conn,"SELECT  count(*) as jumlah from tb_karyawan where status_kepegawaian='guru' and npsn ='$npsn'");
  $jumlah_guru = mysqli_fetch_array($sql_jumlah_guru);
  $sql_jumlah_guru = mysqli_query($conn,"SELECT  count(*) as jumlah from tb_karyawan where npsn ='$npsn'");
  $jumlah_guru = mysqli_fetch_array($sql_jumlah_guru);
  $sql_jumlah_siswa = mysqli_query($conn,"SELECT  count(*) as jumlah from tb_siswa where npsn='$npsn'");
  $jumlah_siswa = mysqli_fetch_array($sql_jumlah_siswa);

  $sql_guru = mysqli_query($conn,"SELECT *  from tb_karyawan where kode_guru ='$kode_guru'");
  $data_guru = mysqli_fetch_array($sql_guru);


  $_SESSION['nama_sekolah'] = $data_guru['nama_karyawan'];
  $_SESSION['foto']         = $data_guru['foto'];
?>
...
<body id="mimin" class="dashboard">
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav" style="margin-right:5%;">
                <li class="user-name"><span><?php echo $_SESSION['nama_login'] ?></span></li>
      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <div id="content" class="profile-v1">
             <div class="col-md-12 col-sm-12 profile-v1-wrapper">
                <div class="col-md-9  profile-v1-cover-wrap" style="padding-right:0px;">
                    <div class="profile-v1-pp">
                      <img src="../admin_sekolah/asset/foto/guru/<?php echo $_SESSION['foto']; ?>"/>
             ...
             <form class="cmxform" method="POST" action="proses/tambah_informasi.php?id=<?php echo $npsn ?>" enctype="multipart/form-data" >
             <div class="col-md-12 col-sm-12 profile-v1-body">
                <div class="col-md-7">
                  ...
                  <?php 
                      ...
                      $sql2 = mysqli_query($conn,"SELECT * FROM tb_info_sekolah where npsn ='$npsn' group by id desc ");
                      $folder = "";
                        ...
                        <div class="panel-body">
                          <div class="col-md-12 padding-0 box-v7-header">
                              <div class="col-md-12 padding-0">
                                  ...
                                  <img src="../admin_sekolah/asset/foto/sekolah/<?php echo $profil_row['foto']; ?>" class="box-v7-avatar pull-left" />
                                  <h4><?php echo $profil_row['nama_sekolah']; ?></h4>
                ...
                <div class="col-md-5">
                     <div class="panel box-v3">
                                ...
                                <center><div style="width:50%; height:50%;">
                                    <img src="asset/foto/sekolah/<?php echo $profil_row['foto']; ?>" class="img-responsive">
                                </div></center>
                                  <div class="media">
                                    ...
                                    <div class="media-body">
                                      <h5 class="media-heading">Nama Sekolah</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['nama_sekolah']; ?></h5>
                                    </div>
                                  </div>
                                  ...
                                  <div class="media">
                                    ...
                                    <div class="media-body">
                                      <h5 class="media-heading">NSS</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['nss']; ?></h5>
                                    </div>
                                  </div>
                                  ...
                                  <div class="media">
                                    ...
                                    <div class="media-body">
                                      <h5 class="media-heading">Nomer Induk Sekolah</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['npsn']; ?></h5>
                                    </div>
                                  </div>

                                  <div class="media">
                                    <div class="media-left">
                                        <span class="icon-direction icons" style="font-size:2em;"></span>
                                    </div>
                                    <div class="media-body">
                                      <h5 class="media-heading">Jalan</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['jalan']; ?></h5>
                                    </div>
                                  </div>
                                   ...
                                   <div class="media">
                                    ...
                                    <div class="media-body">
                                      <h5 class="media-heading">Desa</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['desa']; ?></h5>
                                    </div>
                                  </div>

                                  <div class="media">
                                    <div class="media-left">
                                        <span class="icon-directions icons" style="font-size:2em;"></span>
                                    </div>
                                    <div class="media-body">
                                      <h5 class="media-heading">Kecamatan</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['kecamatan']; ?></h5>
                                    </div>
                                  </div>

                                  <div class="media">
                                    <div class="media-left">
                                        <span class="icon-compass icons" style="font-size:2em;"></span>
                                    </div>
                                    <div class="media-body">
                                      <h5 class="media-heading">Kota</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['kota']; ?></h5>
                                    </div>
                                  </div>

                                  <div class="media">
                                    <div class="media-left">
                                        <span class="icon-map icons" style="font-size:2em;"></span>
                                    </div>
                                    <div class="media-body">
                                      <h5 class="media-heading">Provinsi</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['provinsi']; ?></h5>
                                    </div>
                                  </div>

                                  <div class="media">
                                    <div class="media-left">
                                        <span class="icon-call-in icons" style="font-size:2em;"></span>
                                    </div>
                                    <div class="media-body">
                                      <h5 class="media-heading">Telfon</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['telefon']; ?></h5>
                                    </div>
                                  </div>
                                  ...
                                  <div class="media">
                                    ...
                                    <div class="media-body">
                                      <h5 class="media-heading">Kode Pos</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['kode_pos']; ?></h5>
                                    </div>
                                  </div>
                                  ...
                                  <div class="media">
                                    ...
                                    <div class="media-body">
                                      <h5 class="media-heading">Tahun Berdiri</h5>
                                      <h5 class="media-heading"><?php echo $profil_row['tahun_berdiri']; ?></h5>
                                    </div>
                                  </div>
                                ...
                                <div class="panel-footer bg-white border-none">
                                    <center>
                                    <a href="form_edit_sekolah_index.php?id=<?php echo $profil_row['npsn']; ?>"><input type="button" class="btn btn-round btn-danger" value="Edit Profil"></a>
                                    </center>
                                </div>
                              </div>
                </div>
