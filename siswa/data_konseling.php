...
<body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
          ...
          $nipd = $_SESSION['nipd'];
					$sql = "SELECT * FROM (SELECT a.*, ka.nama_karyawan FROM tb_karyawan as ka JOIN (SELECT k.*, s.nama_siswa, s.nisn FROM tb_konseling as k join tb_siswa as s on k.nipd = s.nipd) as a ON ka.kode_guru = a.kode_guru) as al join tb_pelanggaran as pl on al.kode_pelanggaran = pl.kode_pelanggaran where al.npsn ='$npsn' and al.nipd ='$nipd'";
					$data = $conn->query($sql);
