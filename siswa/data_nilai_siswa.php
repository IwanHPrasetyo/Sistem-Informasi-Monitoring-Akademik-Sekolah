...
<body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
          ...
          $nipd = $_SESSION['nipd'];
					...
					$sql = "SELECT * FROM tb_nilai_akademik as a join tb_siswa as s on a.nipd = s.nipd join tb_pelajaran as p on a.kode_mapel = p.kode_mapel join tb_kelas as k on a.id_kelas= k.id_kelas join tb_jurusan as j on a.id_jurusan = j.id_jurusan where a.npsn ='$npsn' and a.nipd ='$nipd'";
					$data = $conn->query($sql);
