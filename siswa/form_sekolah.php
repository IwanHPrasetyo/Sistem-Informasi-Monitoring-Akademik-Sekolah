                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      ...
                      <form class="cmxform" method="POST" action="proses/tambah_sekolah.php" enctype="multipart/form-data">
                          
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            	<center><img id="gambar" src="asset\img\tambah_picture.png" style="width:20%;";  class="form-text"/></center>	
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="npsn" required>
                              <span class="bar"></span>
                              <label><span class="fa-graduation-cap fa"></span>NPSN</label>
                            </div>
						  

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="nss" required>
                              <span class="bar"></span>
                              <label><span class="fa-institution fa"></span>NSS</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="nama_sekolah" required>
                              <span class="bar"></span>
                              <label><span class="fa-user fa"></span>Nama Sekolah</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="jalan" required>
                              <span class="bar"></span>
                              <label><span class="fa-bed fa"></span>Jalan</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="desa" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="kota" required>
                              <span class="bar"></span>
                              <label><span class="fa-bed fa"></span>Kota/Kabupaten</label>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="provinsi" required>
                              <span class="bar"></span>
                              <label><span class="fa-bed fa"></span>Provinsi</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="telefon" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="kode_pos" required>
                              <span class="bar"></span>
                              <label><span class="fa-bed fa"></span>Kode Pos</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="tahun_berdiri" required>
                              <span class="bar"></span>
