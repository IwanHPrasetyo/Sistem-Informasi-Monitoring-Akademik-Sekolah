                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      ...
                      <form class="cmxform" method="POST" action="proses/tambah_siswa.php?id=<?php echo $npsn ?>" enctype="multipart/form-data">
                          
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            	<center><img id="gambar" src="asset/img/avatar.jpg" style="width:20%;"  class="form-text"/></center>	
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="nipd" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              ...
                              <input type="text" class="form-text"  name="nisn" required>
                              <span class="bar"></span>
                              <label><span class="fa-institution fa"></span>NISN</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="nama_siswa" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:10px !important;">
                              <input type="text" class="form-text mask-date"  name="tanggal_lahir" required>
                        		<span class="bar"></span>
                            <label><span class="fa-calendar fa"></span>Tanggal Lahir</label> 
                      			</div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <textarea rows="4" cols="50" class="form-text" name="alamat" required></textarea>
                              <span class="bar"></span>
                              <label><span class="fa-map-o fa"></span>Alamat</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="number" class="form-text"  name="telefon" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <select class="form-text" name="jurusan" required>
                                    ...
                                    $sql_jurusan = mysqli_query($conn,"SELECT * FROM tb_jurusan where npsn = '$npsn'");
                                    
                                    while($data_jurusan = mysqli_fetch_array($sql_jurusan)){

                                      echo "<option>".$data_jurusan['nama_jurusan']."</option>";
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="nama_ayah" required>
                              <span class="bar"></span>
                              <label><span class="fa-male fa"></span>Nama Ayah</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="pekerjaan_ayah" required>
                              <span class="bar"></span>
                              <label><span class="fa-suitcase fa"></span>Pekerjaan Ayah</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="nama_ibu" required>
                              <span class="bar"></span>
                              <label><span class="fa-female fa"></span>Nama Ibu</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="pekerjaan_ibu" required>
                              <span class="bar"></span>
                              <label><span class="fa-suitcase fa"></span>Pekerjaan Ibu</label>
                            </div>

                             <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="nama_wali" required>
                              <span class="bar"></span>
                              <label><span class="fa-users fa"></span>Nama Wali </label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="pekerjaan_wali" required>
                              <span class="bar"></span>
                              <label><span class="fa-suitcase fa"></span>Pekerjaan Wali</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="number" class="form-text" name="anak_ke" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="asal_sekolah" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="password" class="form-text" name="password_siswa" required>
                              <span class="bar"></span>
                              <label><span class="fa-suitcase fa"></span>Password Siswa</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="password" class="form-text" name="password_wali" required>
                              <span class="bar"></span>
                              <label><span class="fa-suitcase fa"></span>Password Wali</label>
                            </div>        
