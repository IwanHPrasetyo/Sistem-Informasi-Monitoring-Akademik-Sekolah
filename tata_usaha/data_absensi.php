          ...
          <!-- end: Left Menu -->
                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_absensi.php"><input type="button" class="btn btn-round btn-info" value="Tambah Data Absensi"/></a>
                      </div>
                        <tr>
                          <th>Kode</th>
                          <th>Nama Siswa</th>
					...
					$sql = "SELECT * FROM tb_absensi as a join tb_pelajaran as p on a.kode_mapel = p.kode_mapel join tb_sekolah as s on a.npsn = s.npsn join tb_siswa as si on a.nipd = si.nipd where a.npsn = '$npsn' and keterangan != ''";
					$data = $conn->query($sql);
            ...
            <form action = 'proses/edit_absensi_keterangan.php?id=<?php echo $row['kode_absensi']; ?>' method="post">
                        ...
                        <td><?php echo $row['tanggal'];?>
					 	...
					 	<td>
             <input type="submit" class="btn btn-round btn-success" value="Edit">
             </form>
             <a href="proses/hapus_absensi.php?id=<?php echo $row['kode_absensi']; ?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a>
             </td>
					 </tr>
					 <?php
					}
