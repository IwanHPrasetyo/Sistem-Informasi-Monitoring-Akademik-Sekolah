                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_jadwal.php"><input type="button" class="btn btn-round btn-info" value="Tambah Jadwal"/></a>
                      </div>
                        <tr>
                          <th>Kode Jadwal</th>
					...
					$sql = "SELECT * FROM tb_jadwal as j join tb_pelajaran as p on j.kode_mapel = p.kode_mapel where j.npsn = '$npsn'";
					$data = $conn->query($sql);
					while($row = $data->fetch_array()){
					 ...
					 <tr>
					 	...
					 	<td>
             <center><a   href="form_edit_jadwal.php?id=<?php echo $row['kode_jadwal'];?>" ><input type="submit" class="btn btn-round btn-info" value="Edit"></a>
             <a   href="proses/hapus_jadwal.php?id=<?php echo $row['kode_jadwal'];?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a></center> 
            </td>
					 </tr>
					 <?php
					}
