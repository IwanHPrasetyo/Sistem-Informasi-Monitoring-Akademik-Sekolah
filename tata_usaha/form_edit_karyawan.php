...
session_start();
 ...
 $npsn = $_SESSION['npsn'];
					...
					$sql = mysqli_query($conn,"SELECT * FROM tb_karyawan  where kode_guru='$id'");

                  $data = mysqli_fetch_array($sql);
                  $jk                 = $data['jk'];
                  $status_kepegawaian = $data['status_kepegawaian'];
                  $bidang             = $data['bidang'];
                  $_SESSION['foto_prfile'] = $data['foto'];
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Form Karyawan</h3>
                        <p class="animated fadeInDown">
                          Form <span class="fa-angle-right fa"></span> Form Karyawan
                        </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      ...
                      <form class="cmxform" method="POST" action="proses/edit_karyawan.php" enctype="multipart/form-data">
                          
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                      <center><img id="gambar" src="asset/foto/guru/<?php echo $data['foto']; ?>" style="width:20%;"  class="form-text"/></center>	
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                      <input type="text" class="form-text" value="<?php echo $data['kode_guru']; ?>"  name="kode_guru" required>
                      <span class="bar"></span>
                      <label><span class="fa-graduation-cap fa"></span>Kode Guru</label>
                    </div>
      

                    <div class="form-group form-animate-text" style="margin-top:40px !important;">

                      <input type="text" class="form-text" value="<?php echo $data['nip']; ?>"  name="nip" required>
                      <span class="bar"></span>
                      <label><span class="fa-institution fa"></span>NIP</label>
                    </div>

                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                      <input type="text" class="form-text" value="<?php echo $data['nama_karyawan']; ?>" name="nama_karyawan" required>
                      <span class="bar"></span>
                      <label><span class="fa-user fa"></span>Nama Karyawan</label>
                    </div>

                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                       <select class="form-text" value="<?php echo $data['jk']; ?>"  name="jenis_kelamin" required>
                  ...
                  <div class="form-group form-animate-text" style="margin-top:40px !important;">
                      <input type="number" class="form-text" value="<?php echo $data['telefon']; ?>"  name="telefon" required>
                      <span class="bar"></span>
                      <label><span class="fa-phone fa"></span>Telefon</label>
                    </div>

                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" value="<?php echo $status_kepegawaian; ?>"  name="status_kepegawaian" required>
                              <span class="bar"></span>
                              <label><span class="fa-user fa"></span>Jabatan</label>
                    </div>

                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                      <select class="form-text" name="bidang" required>
                            <option>Bidang</option>
                            <?php 
                            $sql_bidang = mysqli_query($conn,"SELECT * from tb_pelajaran where npsn ='$npsn'");
                            while($data_bidang = mysqli_fetch_array($sql_bidang)){
                            ?>
                            <option value="<?php echo $data_bidang['nama_pelajaran']?>"<?php if($bidang==$data_bidang['nama_pelajaran']) echo 'selected="selected"'; ?>><?php echo $data_bidang['nama_pelajaran']; ?></option>
                            <?php 
                            }
                            ?>        
                      </select>
