...
$id_pembayarann = $_GET['id'];

$sql_pembayaran  = mysqli_query($conn,"SELECT * FROM tb_pembayaran where id_pembayaran = '$id_pembayarann'");
$data_pembayaran = mysqli_fetch_array($sql_pembayaran);

$id_tagihan = $data_pembayaran['id_tagihan'];
$sql = "SELECT * FROM tb_tagihan";
$data = $conn->query($sql);

$sql_tagihan  = mysqli_query($conn,"SELECT * FROM tb_tagihan where id_tagihan='$id_tagihan'");
$data_tagihan = mysqli_fetch_array($sql_tagihan);
$nama_tagihan = $data_tagihan['nama_tagihan'];


$nipd = $data_pembayaran['nipd'];
$sql_siswa = mysqli_query($conn,"SELECT * FROM tb_siswa where nipd='$nipd'");
                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="post" action="proses/edit_pembayaran.php?id=<?php echo $data_pembayaran['id_pembayaran']; ?>">
                          <div class="col-md-12">
      
                          <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <div class="search-box">
                            <input type="text" autocomplete="off" class="form-text" value="<?php echo $data_siswa['nama_siswa']; ?>" name="nama_siswa" required>
                            <span class="bar"></span>
                          ...
                          <div class="form-group form-animate-text" style="margin-top:40px !important;">
                               <select class="form-text" name="nama_tagihan" id="nama_tagihan" required>
                                    ...
                                    <?php while($row = $data->fetch_array()){ ?>
                                        ...
                                        <option value="<?php echo $row['nama_tagihan']; ?>"<?php if($nama_tagihan==$row['nama_tagihan']) echo 'selected="selected"'; ?>><?php echo $row['nama_tagihan']; ?></option>";
                                   <?php }?>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <input type="text" class="form-text" value="<?php echo "Rp.".number_format($data_tagihan['nominal_tagihan'],0,',','.');?>" name="nominal_tagihan" id="nominal_tagihan" required>
                            <span class="bar"></span>
                            <label><span class="fa-calendar fa"></span>Nominal Tagihan</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <input type="text" class="form-text"value="<?php echo "Rp.".number_format($data_pembayaran['nominal_pembayaran'],0,',','.');?>" name="nominal_pembayaran" id="nominal_pembayaran" required>
                            <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <input type="text" class="form-text mask-date" value="<?php echo $data_pembayaran['tanggal_pembayaran']; ?>" name="tanggal_pembayaran" required>
                            <span class="bar"></span>
