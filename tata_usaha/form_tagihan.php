...
$sql_kelas = mysqli_query($conn,"SELECT * FROM tb_tagihan where npsn='$npsn'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="post" action="proses/tambah_tagihan.php">
                          <div class="col-md-12">
                         
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="nama_tagihan" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <textarea rows="4" cols="50" class="form-text" name="keterangan" required></textarea>
                            <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <input type="text" class="form-text mask-date" name="tanggal_terbit" required="">
                            <span class="bar"></span>
                            <label><span class="fa-calendar fa"></span>Tanggal Terbit</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <input type="text" class="form-text mask-date" name="tanggal_akhir" required="">
                            <span class="bar"></span>
