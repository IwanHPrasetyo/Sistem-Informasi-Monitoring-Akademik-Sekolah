                ...
                <div class="col-md-12">
                  <div class="panel">
                    ...
                    <div class="panel-body">
                      ...
                      <thead>
                      <div style="padding:1%;">
                          <a href="form_nilai_siswa.php"><input type="button" class="btn btn-round btn-info" value="Tambah Nilai Siswa"/></a>
                      </div>
                        <tr>
                          <th>Kode</th>
                          <th>NIPD</th>
					...
					$sql = "SELECT * FROM tb_nilai_akademik as a join tb_siswa as s on a.nipd = s.nipd join tb_pelajaran as p on a.kode_mapel = p.kode_mapel join tb_kelas as k on a.id_kelas= k.id_kelas join tb_jurusan as j on a.id_jurusan = j.id_jurusan where a.npsn ='$npsn'";
					$data = $conn->query($sql);
					while($row = $data->fetch_array()){
					 ...
					 <tr>
					 	...
					 	<td>
             <center><a   href="proses/hapus_nilai_siswa.php?id=<?php echo $row['id_nilai']; ?>" ><input type="submit" class="btn btn-round btn-danger" value="Hapus"></a></center>
					 	</td>
					 </tr>
					 <?php
					}
