...
$sql   = mysqli_query($conn,"SELECT * FROM tb_tagihan WHERE id_tagihan = '$id_tagihan'");
                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="post" action="proses/edit_tagihan.php?id=<?php echo $data['id_tagihan']; ?>">
                          <div class="col-md-12">
                         
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" value="<?php echo $data['nama_tagihan']; ?>" name="nama_tagihan" required>
                              <span class="bar"></span>
                              <label><span class="fa-graduation-cap fa"></span>Nama Tagihan</label>
                            </div>
						  

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">

                              <input type="text" class="form-text" value="<?php echo $format = "Rp.".number_format($nominal_tagihan,0,',','.'); ?>"  name="nominal_tagihan" id="nominal_tagihan" required>
                              <span class="bar"></span>
                              <label><span class="fa-institution fa"></span>Nominal Tagihan</label>
                            </div>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <textarea rows="4" cols="50" class="form-text" name="keterangan" required><?php echo $data['keterangan']; ?></textarea>
                            <span class="bar"></span>
                            <label><span class="fa-map-o fa"></span>Keterangan</label>
                            </div>
                            

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <input type="text" class="form-text mask-date" value="<?php echo $data['tanggal_terbit']; ?>" name="tanggal_terbit" required="">
                            <span class="bar"></span>
                            <label><span class="fa-calendar fa"></span>Tanggal Terbit</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <input type="text" class="form-text mask-date" value="<?php echo $data['nominal_akhir']; ?>" name="tanggal_akhir" required="">
                            <span class="bar"></span>
                            <label><span class="fa-calendar fa"></span>Tanggal Akhir</label>
                            </div>
