                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="post" action="proses/tambah_konseling.php">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                               <select class="form-text" name="nama_pelanggaran" required>
                              
                                    <option>Jenis Pelanggaran</option>
                                    <?php while($row = $data->fetch_array()){ 

                                        echo " <option>".$row['nama_pelanggaran']."</option>";
                                    }?>
                            ...
                            <span class="bar"></span>
                              <label><span class="fa-male fa"></span>Keterangan</label>
                            </div>
