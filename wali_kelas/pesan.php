                          ...
                          <div class="col-md-12 mail-right-content">
                              <table class="table table-hover">
                                 ...
                                 <tr class="read">        
                                    ...
                                    <span><img width="20%" src="asset/foto/guru/sman1malang.png" /></span><br><strong>Kepala Sekolah</strong>
                                    </td>
                                     <td class="subject">
                                      <a href="baca_pesan.php">Nunc nonummy metus. Mauris sollicitudin fermentum libero.</a>
                                      </td>
                                  </tr>
