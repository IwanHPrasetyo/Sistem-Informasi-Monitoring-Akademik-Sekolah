...
session_start();
        ...
        if($bidang == "Bidang"){
         ...
         $sql =mysqli_query($conn,"update tb_karyawan set nip='$nip', npsn='$npsn', nama_karyawan='$nama_karyawan', jk='$kodeJK', status_kepegawaian='$status_kepegawaian', bidang='$jabatan', telefon='$telefon', alamat='$alamat', foto='$file_name' where kode_guru = '$kode_guru';")
													  or die(mysqli_error());
