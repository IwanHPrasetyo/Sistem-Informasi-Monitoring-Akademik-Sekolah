...
<body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
          ...
          $nipd = $_SESSION['nipd'];
					$sql = "SELECT * FROM tb_pembayaran as p join tb_siswa as s on p.nipd = s.nipd join tb_tagihan as t on p.id_tagihan = t.id_tagihan where p.npsn='$npsn' and p.nipd ='$nipd'";
					$data = $conn->query($sql);
