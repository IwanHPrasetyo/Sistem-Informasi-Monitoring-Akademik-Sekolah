...
<?php
  ...
  $sql_jurusan = mysqli_query($conn,"SELECT * FROM tb_jurusan where id_jurusan='$id'");
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Form Jurusan</h3>
                        <p class="animated fadeInDown">
                          Form <span class="fa-angle-right fa"></span> Form Jurusan
                        </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Form Jurusan Pelajaran</h4>
                    </div>
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      
                      <div class="col-md-12">
                      
                      <form class="cmxform" method="POST" action="proses/edit_jurusan.php?id=<?php echo $data_jurusan['id_jurusan'];?>" enctype="multipart/form-data">

                          <div class="col-md-12">

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" value="<?php echo $data_jurusan['nama_jurusan']; ?>" name="nama_jurusan" required>
                              <span class="bar"></span>
                              <label><span class="fa-graduation-cap fa"></span>Nama Jurusan</label>
                            </div>
