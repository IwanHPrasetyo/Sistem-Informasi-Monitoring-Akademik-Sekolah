                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel">
                    ...
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      ...
                      <form class="cmxform" method="POST" action="proses/tambah_karyawan.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="kode_guru" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" name="nama_karyawan" required>
                              <span class="bar"></span>
                          ...
                          <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text"  name="status_kepegawaian" required>
                              <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                               <select class="form-text" name="bidang" required>
                                    ...
                                    <?php $sql_bidang = mysqli_query($conn,"SELECT * FROM tb_pelajaran where npsn='$npsn'"); 
                                    
                                    while($data_pelajaran = mysqli_fetch_array($sql_bidang)){

                                      echo " <option>".$data_pelajaran['nama_pelajaran']."</option>";
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              ...
                              <span class="bar"></span>
                              <label><span class="fa-lock fa"></span>Password</label>
                            </div>
