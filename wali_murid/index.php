<?php 
  ...
  $sql_guru = mysqli_query($conn,"SELECT *  from tb_siswa where nipd ='$kode_guru'");
  $data_guru = mysqli_fetch_array($sql_guru);


  $_SESSION['nama_sekolah'] = $data_guru['nama_siswa'];
             ...
             <div class="col-md-12 col-sm-12 profile-v1-wrapper">
                <div class="col-md-9  profile-v1-cover-wrap" style="padding-right:0px;">
                    <div class="profile-v1-pp">
                      <img src="../admin_sekolah/asset/foto/siswa/<?php echo $_SESSION['foto']; ?>"/>
