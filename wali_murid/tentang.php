...
<head>
  ...
  <title>Sistem Infomasi Monitoring Akademik Siswa</title>
        ...
        <div id="content" class="article-v1">
            <div class="panel box-shadow-none content-header">
                <div class="panel-body">
                  <div class="col-md-12">
                      <h3 class="animated fadeInLeft">Tentang</h3>
                      <p class="animated fadeInDown">
                        Profil <span class="fa-angle-right fa"></span> Tentang
                      </p>
                  </div>
                </div>
            </div>
            <div class="col-md-12">
              <div class="panel">
                <div class="pull-right article-v1-time">
                  <em> Iwan H Prasetyo</em></div>
                  <div class="panel-body">
                    <div class="col-md-12 text-left article-v1-title"><h2>Trimakasih</h2></div>
